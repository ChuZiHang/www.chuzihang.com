...
public class CodeGenerator {
     ...
     * JDBC配置，请修改为你项目的实际配置
     */
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/chuzihang";
     ...
     * @author
     */
    private static final String AUTHOR = "Q_先生";
    /**
     * @date
     */
    private static final String DATE = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm"));
