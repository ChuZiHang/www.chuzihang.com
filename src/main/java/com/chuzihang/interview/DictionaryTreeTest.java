package com.chuzihang.interview;

import java.util.HashMap;
import java.util.Map;

/**
 * @ClassName DictionaryTreeTest
 * @Description TODO 如何在500w个单词中统计特定前缀的单词有多少个
 * @Author Q_先生
...
public class DictionaryTreeTest {
    ...
    /**
     * @Author Q_先生
     * @Description //TODO 字典树的节点
     * @Date 9:56 2018/10/11
     * @Param
     * @return
     **/
    private class Node {
        ...
        Node(boolean isWord, int count, String str) {
            this();
            this.isWord = isWord;
            this.count = count;
            this.str = str;
    ...
    public static void main(String[] args) {
        DictionaryTreeTest dt = new DictionaryTreeTest();
